package com.myneflow.davisi.ui.recharge
...
import com.myneflow.davisi.ui.recharge.component.ContentRecharge
    ...
    override fun onCreateView(
        ...
        return ComposeView(requireContext()).apply {
            setContent {
                ...
                TopCard(this@RechargeFragment, isDataVisible)
                val cardImages = listOf(
                    R.drawable.bg_signup,
                    R.drawable.card_1,
                    R.drawable.shape,
                )
                AppBarConf("Recharge", navController,
                    onIconClick = {
